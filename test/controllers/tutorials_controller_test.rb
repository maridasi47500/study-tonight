...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference("Tutorial.count") do
      post tutorials_url, params: { tutorial: { content: @tutorial.content, mytutoriallist_id: @tutorial.mytutoriallist_id, name: @tutorial.name } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { content: @tutorial.content, mytutoriallist_id: @tutorial.mytutoriallist_id, name: @tutorial.name } }
