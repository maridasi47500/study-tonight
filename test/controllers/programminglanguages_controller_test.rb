...
class ProgramminglanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create programminglanguage" do
    assert_difference("Programminglanguage.count") do
      post programminglanguages_url, params: { programminglanguage: { code: @programminglanguage.code, name: @programminglanguage.name } }
    end
  ...
  test "should update programminglanguage" do
    patch programminglanguage_url(@programminglanguage), params: { programminglanguage: { code: @programminglanguage.code, name: @programminglanguage.name } }
